...
| P002 | [Provider instruction injection](plans/002-provider-instruction-injection/README.md) | `npm-installer`, `python-installer`, `provider-instructions`, `public-docs`, `release-automation` | In Progress | Registry publication recovery | [v0.4.0 GitHub Release](plans/002-provider-instruction-injection/evidence/2026-08-13-v0.4.0-github-release.md) | Fix npm publishing authorization, then complete and verify registries |
