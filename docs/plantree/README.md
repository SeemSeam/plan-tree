...
| P002 | [Provider instruction injection](plans/002-provider-instruction-injection/README.md) | `npm-installer`, `python-installer`, `provider-instructions`, `public-docs`, `release-automation` | In Progress | npm Trusted Publisher gate | [v0.4.0 release candidate](plans/002-provider-instruction-injection/evidence/2026-08-13-v0.4.0-release-candidate.md) | Confirm npm trust, then tag and verify v0.4.0 |
